...
export default function App() {
    ...
    return (
        ...
        >
            ...
            {/* Header Flat */}
            <header className="bg-slate-950 text-white p-4 flex justify-between items-center border-b border-slate-800 z-30">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button
                        ...
                        className="flex flex-col items-end gap-0.5 group cursor-pointer mr-4"
                        title="Ajustar PEM"
                    >
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <section className="flex-1 flex flex-col bg-white overflow-hidden relative">
                    <div className="border-b border-slate-200 p-2 flex justify-between items-center bg-slate-50">
                ...
                {/* Resizer Handle */}
                <div
                    className="w-1 bg-slate-200 hover:bg-blue-400 cursor-col-resize transition-colors z-30"
